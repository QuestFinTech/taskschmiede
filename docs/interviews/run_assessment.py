...
HOST = "arcus.home.arpa:8000"
API_KEY = "vns-9a2a86851d8f2acd5b4e7f27a966629a340fdb32f3507e9480153d595c44829b"
MODEL = "gpt-oss-120b"
...
def main():
    ...
    with open("docs/interviews/raw_results.json", "w") as f:
        json.dump(output, f, indent=2)
    print(f"\nRaw results saved to docs/interviews/raw_results.json")
